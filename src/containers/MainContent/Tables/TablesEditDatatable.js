...
class TablesEditDatatable extends Component {    
    render() {
                        ...
                        <div className="col-12">
                            <div className="card m-b-20">
                                <div className="card-body">
                                    ...
                                    <p className="text-muted m-b-30">just start typing to edit, or move around with arrow keys or mouse clicks!</p>
...
export default TablesEditDatatable;