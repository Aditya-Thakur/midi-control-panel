            ...
            <div className="col-lg-4">
                        <div className="card">
                            <div className="card-body">
                                <h6 className="card-title">Adv. Id: {this.props.advData.advId} <span className="badge badge-primary float-right">Rs. {this.props.advData.advCost}</span></h6>
                                <h5 className="card-subtitle font-15 text-muted">From <cite title="Source Title">{this.props.advData.advBrandName}</cite></h5>
                            </div>
                            ...
                            <div className="card-body" data-toggle="collapse" data-target={"#"+this.props.advId+"collapse_user_data"} aria-expanded="false" aria-controls={this.props.advId+"collapse_user_data"}>
                                <div className="row">
                                    <div className="col-md-7">
                                        <h6 className="blockquote-footer card-subtitle font-14 text-muted">User Preferred Details</h6>
                                    </div>
                                    <div className="col-md-5">
                                        <div className="card-subtitle float-right" ><i className="ti-angle-down"></i></div>
                                    </div>
                            ...
                            <div className="collapse" id={this.props.advId+"collapse_user_data"}>
                                <div className="card-body">
                                    <ul className="ml-3 list-group list-group-flush">
                                        ...
                                        <li>Preferred Age Range: <span className="badge badge-warning float-right">{this.props.advData.advAgePref}</span></li>
                                   {/*     <li>Time-wise Distribution <span className="badge badge-danger float-right">9AM-11AM</span></li> */}
                                        <li>Target Gender<span className="badge badge-dark float-right">{this.props.advData.advGenderPref}</span> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
