    ...
    constructor(){
      ...
      handleRange(e){
        this.setState({range:  e.target.value}); 
          ...
          else if(this.state.range > 5 && this.state.range < 10)
            this.setState({range_err: ''});
          else 
            this.setState({range_err: 'InValid Range. It should be between 5 and 10.'});  
      }
      handleMinv(e){
                            ...
                            <div className="col-lg-6">
                                <div className="card m-b-20">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div>
                                            <input type="text" className="form-control"  value={this.state.range} onChange={this.handleRange}
                                                    placeholder="Text between 5 - 10 chars length" />
                                            <span id="err">{this.state.range_err}</span>
                                        </div>
                                    </div>
                                    <div className="form-group">
