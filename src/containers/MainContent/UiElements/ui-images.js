                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="card m-b-30">
                                    <div className="card-body">
                                        ...
                                        <p className="text-muted m-b-30 font-14">Use classes
                                            <code>.rounded</code> and <code>.rounded-circle</code>.</p>
        
                                        <div className="">
                                            <img className="rounded mr-2" alt="200x200" width="200" src="assets/images/small/img-4.jpg" data-holder-rendered="true"/>
                                ...
                                <div className="card m-b-30">
                                    <div className="card-body">
                                        ...
                                        <div className="media m-b-30">
                                            <img className="d-flex mr-3 rounded-circle" src="assets/images/users/user-6.jpg" alt="Generic placeholder image" height="64"/>
                                        ...
                                        <div className="media m-b-30">
                                            <img className="d-flex mr-3 rounded-circle" src="assets/images/users/user-2.jpg" alt="Generic placeholder image" height="64"/>
                                            <div className="media-body">
                                                <h5 className="mt-0 font-18">Media heading</h5>
                                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                                ...
                                                <div className="media mt-3">
                                                    <a className="d-flex pr-3" href="#">
                                                        <img src="assets/images/users/user-3.jpg" alt="Generic placeholder image" height="64" className="rounded-circle"/>
                                                    </a>
                                                    <div className="media-body">
                                                        <h5 className="mt-0 font-18">Media heading</h5>
                                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                        ...
                                        <div className="media">
                                            ...
                                            <img className="d-flex ml-3 rounded-circle" src="assets/images/users/user-4.jpg" alt="Generic placeholder image" height="64"/>
                                        </div>
                            ...
                            <div className="col-12">
                                <div className="card m-b-30">
                                    <div className="card-body">
                                        ...
                                        <div className="media m-b-30">
                                            <img className="d-flex align-self-start rounded mr-3" src="assets/images/users/user-3.jpg" alt="Generic placeholder image" height="64"/>
                                            <div className="media-body">
                                        ...
                                        <div className="media m-b-30">
                                            <img className="d-flex align-self-center rounded mr-3" src="assets/images/users/user-5.jpg" alt="Generic placeholder image" height="64"/>
                                            <div className="media-body">
                                        ...
                                        <div className="media">
                                            <img className="d-flex align-self-end rounded mr-3" src="assets/images/users/user-1.jpg" alt="Generic placeholder image" height="64"/>
                                            <div className="media-body">
