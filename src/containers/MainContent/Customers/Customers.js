                            ...
                            <div className="col-12">
                                <div className="card m-b-20">
                                    <div className="card-body">
                                        ...
                                        <p className="text-muted m-b-30 font-14">Creating ad content which implies knowledge of personally identifiable information or sensitive information about your customers ;
                                         Using a customer list that targets an overly narrow or specific audience.
                                        </p>
